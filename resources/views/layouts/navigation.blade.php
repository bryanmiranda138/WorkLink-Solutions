        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <img src="{{ asset('images/worklink_logo.png') }}" alt="Logo" class="block h-9 w-auto fill-current">
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link 
                    :href="route(Auth::user()->getDashboardRouteName())" 
                    :active="request()->routeIs(Auth::user()->getDashboardRouteName())"
                >
                    {{ __('Inicio') }}
                </x-nav-link>
                @if (!isset($postulante))
